...
<p align="center">Архитектура сети DeepLabV3+</p>
...
<p align="justify">Функция для архитектуры Atrous Spatial Pyramid Pooling (ASPP):</p>
...
def ASPP(inputs):  
  ...
  return y
```
<p align="justify">Функция для полной Архитектуры DeepLab3V+:</p>
...
<ul>
  ...
  <p align="center">
<img src = "./test_images/results/3.png" width = 480 height = 240>  
<br>Предсказание нового изображения</p>
