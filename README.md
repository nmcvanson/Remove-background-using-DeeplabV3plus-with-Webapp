...
<p align="justify">Проведя некоторые исследования, мы остановились на трех доступных нам моделях: FCN, Unet, Tiramisu и DeepLabv3+.</p>
...
<p align="justify">Одна из недавних моделей, которая хорошо показала себя на задаче семантической сегментаций на разных датасетах - <a href =  "https://arxiv.org/pdf/1802.02611v3.pdf" DeepLabv3+</a>.
